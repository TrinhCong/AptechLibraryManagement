...
<body>
	...
	<div class="portlet light no-margin">
		<div class="portlet-title">
			<div class="caption">
				<span class="caption-subject font-green-sharp bold uppercase">Authors Management</span>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-md-6">
						<a class="btn btn-sm green" data-toggle="modal" role="button"
							href="#modal-create" id="create">Add Author <i
							class="fa fa-plus"></i>
						</a>
					</div>
				</div>
		...
		<div class="modal-body">
			<form action="/NWPProduct/Update" method="post"
				...
				<div class="form-group">
					<label for="" class="control-label col-sm-4">Author Name<span
	...
	<div id="modal-create" class="modal fade" tabindex="-1"
		...
		<div class="modal-body">
			<form action="/library-management/author/create" class="form-horizontal data-form"
	...
	<script src="<c:url value='/resources/assets/apps/scripts/author.js' />"></script>
