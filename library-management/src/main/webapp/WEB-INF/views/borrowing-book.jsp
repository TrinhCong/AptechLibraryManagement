...
<body>
		...
		<div class="modal-body">
			<form
				...
				<div class="form-group">
					<label for="" class="control-label col-sm-4">Users<span
				...
				<div class="form-group">
					<label for="" class="control-label col-sm-4">Rent Price<span
						class="required">*</span></label>
					<div class="col-sm-8">
						<input type="number" class="form-control" name="rental" min="1" step="1"
							required />
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="" class="control-label col-sm-4">Returned<span
						class="required">*</span></label>
					<div class="col-sm-8">
	...
	<div id="modal-create" class="modal fade" tabindex="-1"
		...
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal"
				aria-hidden="true"></button>
			<h4 class="modal-title">Lease Book</h4>
		</div>
		<div class="modal-body">
	...
	<script src="<c:url value='/resources/assets/apps/scripts/borrowing-book.js' />"></script>
