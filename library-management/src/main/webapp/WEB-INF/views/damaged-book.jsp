...
<body>
				...
				<div class="row">
					<div class="col-md-6">
						<a class="btn btn-sm green" data-toggle="modal" role="button"
							href="#modal-create" id="create">New damaged Book <i
							class="fa fa-plus"></i>
						</a>
					</div>
				</div>
	...
	<div id="modal-create" class="modal fade" tabindex="-1"
		...
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal"
				aria-hidden="true"></button>
			<h4 class="modal-title">New Damaged Book</h4>
		</div>
		<div class="modal-body">
	...
	<script src="<c:url value='/resources/assets/apps/scripts/damaged-book.js' />"></script>
