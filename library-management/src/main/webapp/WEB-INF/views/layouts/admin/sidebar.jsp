		...
		<ul
			...
			<li class="nav-item"><a href="#" class="nav-link nav-toggle">
					<i class="fa fa-file-text-o"></i> <span class="title">Lập
						báo cáo</span> <span class="arrow"></span>
			</a>
				<ul class="sub-menu">
					<li class="nav-item "><a
						href="/Monitor/EvaluateBulletinReport" class="nav-link ajaxify">
							<i class="fa fa-file-o"></i> <span class="title">Dự báo
								điểm</span>
					</a></li>
					<li class="nav-item "><a
						href="/Monitor/EvaluateVerificationReport"
