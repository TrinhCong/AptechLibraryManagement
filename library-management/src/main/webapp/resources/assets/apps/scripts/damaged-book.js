class DamagedBookHandler {
    ...
    constructor() {
        ...
        $('.data-form').ajaxForm({
            beforeSubmit: function(formData, jqForm, options) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/library-management/damaged-book/save",
    ...
    _loadTable() {
        ...
        this.dataTable = this.$table.dataTable({
            ...
            "ajax": {
                ...
                dataType: 'json',
                url: "/library-management/damaged-book/list",
                data: function(d) {
    ...
    _deleteItem(selectedRow) {
        var data = this.dataTable.fnGetData(selectedRow);
        Aptech.confirm("Are you sure to delete this damaged-book?", function(result) {
            if (result) {
                let param = { id: data.id };
                console.log(param);
                $.ajax({
                    url: "/library-management/damaged-book/delete",
