...
var Layout = function() {
    ...
    var handleSidebarAndContentHeight = function() {
        ...
        sidebar.find('.page-sidebar-menu').height(parseInt(content.css('min-height')) - $('.page-container > nav').outerHeight());
        content.css('min-height', parseInt(content.css('min-height')) - $('.page-container > nav').outerHeight());
        contentBody.height(parseInt(content.css('min-height')) - $('.page-container > nav').outerHeight() - 35);
    };
...
var Aptech = function() {
    return {
        ...
        isValidPassword(pass) {
            //Mật khẩu phải có chữ và số, bao gồm ít nhất 6 kí tự
